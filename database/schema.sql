...
CREATE TABLE orders (
    ...
    merchant_name_snapshot VARCHAR(100),
    merchant_logo_snapshot VARCHAR(512),
    create_time DATETIME NOT NULL,
    paid_at DATETIME,
...
CREATE TABLE order_refund_dispute (
    ...
    INDEX idx_order_refund_dispute_status (status, created_at),
    INDEX idx_order_refund_dispute_order (order_id, created_at)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
