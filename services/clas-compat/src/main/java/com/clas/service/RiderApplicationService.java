...
public class RiderApplicationService {
    ...
    public java.util.List<com.clas.dto.RoleApplicationRecordResponse> listApplicationRecords(String userId) {
        return applications.selectList(new LambdaQueryWrapper<RiderApplication>()
            ...
            .stream()
            .map(item -> new com.clas.dto.RoleApplicationRecordResponse(
