...
@Configuration
public class CompatWebConfig implements WebMvcConfigurer {
    ...
    public CompatWebConfig(AuthInterceptor authInterceptor, InternalServiceAuthInterceptor internalServiceAuthInterceptor) {
