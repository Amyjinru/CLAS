## Purpose
Compute admin dashboard statistics, merchant/product rankings, and batch order/review details through SQL aggregation and bounded queries instead of in-memory processing.
