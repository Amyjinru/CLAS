## Purpose
Expose REST APIs through authenticated current-user/merchant/admin contexts that derive identity from tokens rather than client-provided path parameters.
